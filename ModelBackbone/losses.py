...
class PointPillarNetworkLoss:
    ...
    def __init__(self):
        self.alpha = float(defs.alpha)
        self.gamma = float(defs.gamma)
        self.focal_weight = float(defs.focal_weight)
        self.loc_weight = float(defs.loc_weight)
        self.size_weight = float(defs.size_weight)
        self.angle_weight = float(defs.angle_weight)
        self.heading_weight = float(defs.heading_weight)
        self.class_weight = float(defs.class_weight)
